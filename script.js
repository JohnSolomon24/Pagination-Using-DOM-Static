...
d3.innerHTML = `<button type="button" class="btn btn-outline-success" value="submit" onClick="first()" style="font-size:30px;">First</button> 
...
for (let i=Previous-20;i < Previous-10;i++)
{
